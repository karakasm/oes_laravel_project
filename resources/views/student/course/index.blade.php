        ...
        <div class="row py-3">
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card text-white my-3 mb-lg-0 bg-success border-0">
                    ...
                    <div class="card-footer text-white text-center">
                        <a href="{{ route('student.course.detail',['course' => $course]) }}"
                ...
                <div class="card text-white my-3 mb-lg-0 bg-warning border-0">
                    <div class="card-body row">
                        <div class="col-8 d-flex flex-column justify-content-between">
                            <h4 class="card-title">{{count($course->announcements->where('status','active')->all())}}
                            </h4>
                    ...
                    <div class="card-footer text-white text-center">
                        <a href="{{route('student.courses.announcements.index',['course' => $course])}}"
                            class="text-white text-decoration-none">
                            <span class="link-name">Detay Göster</span>
                            <i class="uil uil-arrow-circle-right link-icon"></i>
                        </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card text-white my-3 mb-lg-0 bg-info border-0">
                    ...
                    <div class="card-footer text-white text-center">
                        <a href="{{ route('student.courses.folders.index',['course' => $course]) }}"
                            class="text-white text-decoration-none">
                            <span class="link-name">Detay Göster</span>
                            <i class="uil uil-arrow-circle-right  link-icon"></i>
                        </a>
