...
Route::prefix('student')->middleware(['auth','is_student'])->group(function () {
    ...
    Route::get('courses/{id}', [CourseController::class, 'index'])->name('student.course.index');
    Route::get('courses/{id}/details',[CourseController::class,'show'])->name('student.course.detail');
});
...
Route::prefix('instructor')->middleware(['auth','is_instructor'])->group(function (){
    ...
    //Routes about courses
    Route::get('courses/{id}',[\App\Http\Controllers\Instructor\CourseController::class,'index'])->name('instructor.course.index');
    Route::get('courses/{id}/details', [\App\Http\Controllers\Instructor\CourseController::class,'show'])->name('instructor.course.detail');
